...
class TestLinenConsistency(parameterized.TestCase):
  ...
  def test_nnx_linen_weightnorm_equivalence(
    ...
    class LinenModel(linen.Module):
      ...
      def setup(self):
        ...
        self.norm_layer = linen.WeightNorm(self.dense, scale_init=scale_init)
  ...
  def test_nnx_linen_spectralnorm_equivalence(
    ...
    linear_state['batch_stats/kernel/u'] = nnx.Param(variables['batch_stats']['norm_layer']['dense/kernel/u'])
    linear_state['batch_stats/kernel/sigma'] = nnx.Param(variables['batch_stats']['norm_layer']['dense/kernel/sigma'])
